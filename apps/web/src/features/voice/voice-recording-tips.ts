...
export const KITS_VOICE_RECORDING_TIPS = [
  "На данной странице вам нужно записать собственный голос.",
  "Далее вы перейдёте на страницу верификации голоса, где нужно напевом повторить другую фразу для корректной сборки AI.",
...
export const VOICE_RECORDING_TOOLTIP =
  "Произнесите следующий текст (~15 секунд): " +
